...
index_prologue="$prologue1 $prologue3"

echo "$index_prologue"  > ../types/index.d.ts
echo "export * from \"./pipeline-flow-v3.ts\";" >> ../types/index.d.ts
echo "export {
